                                ...
                                <div className="tab_content">
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-lg-6 col-md-12 why-we-different-img">
                                                <div className="tabs_item_img">
                                                    <img src={require("../../images/why-we-different1.jpg")} alt="img" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab2" className="tabs_item">
                                        <div className="row align-items-center">
                                            <div className="col-lg-6 col-md-12 why-we-different-img">
                                                <div className="tabs_item_img">
                                                    <img src={require("../../images/why-we-different2.jpg")} alt="img" />
                                                </div>
                                            </div>
                                    ...
                                    <div id="tab3" className="tabs_item">
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-lg-6 col-md-12 why-we-different-img">
                                                <div className="tabs_item_img">
                                                    <img src={require("../../images/why-we-different3.jpg")} alt="img" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab4" className="tabs_item">
                                        <div className="row align-items-center">
                                            <div className="col-lg-6 col-md-12 why-we-different-img">
                                                <div className="tabs_item_img">
                                                    <img src={require("../../images/why-we-different4.jpg")} alt="img" />
                                                </div>
                                            </div>
