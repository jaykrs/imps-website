...
class MainBannerThirteen extends Component {
    // Video modal
    state = {
        isOpen: false,
    }
        ...
        return (
            <React.Fragment>
                ...
                id="home" className="home-slides owl-carousel owl-theme"
                    {...options}
                >
                    <div className="main-banner gradient-banner item-bg2">
                    ...
                    <div className="main-banner gradient-banner item-bg3">
                        <div className="d-table">
                            <div className="d-table-cell">
                                <div className="container">
                                    <VisibilitySensor>
                    ...
                    <div className="main-banner gradient-banner item-bg1">
                        <div className="d-table">
                            <div className="d-table-cell">
                                <div className="container">
                                    <VisibilitySensor>
...
export default MainBannerThirteen;